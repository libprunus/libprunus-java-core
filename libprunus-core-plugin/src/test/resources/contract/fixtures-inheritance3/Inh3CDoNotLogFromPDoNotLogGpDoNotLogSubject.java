...
@DoNotLog
public class Inh3CDoNotLogFromPDoNotLogGpDoNotLogSubject extends Inh3PDoNotLogFromGpDoNotLogSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CDoNotLogFromPDoNotLogGpDoNotLogSubject inst = new Inh3CDoNotLogFromPDoNotLogGpDoNotLogSubject();
