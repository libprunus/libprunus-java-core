...
@DoNotLog
public class Inh3CDoNotLogFromPSensitiveGpSensitiveSubject extends Inh3PSensitiveFromGpSensitiveSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CDoNotLogFromPSensitiveGpSensitiveSubject inst = new Inh3CDoNotLogFromPSensitiveGpSensitiveSubject();
