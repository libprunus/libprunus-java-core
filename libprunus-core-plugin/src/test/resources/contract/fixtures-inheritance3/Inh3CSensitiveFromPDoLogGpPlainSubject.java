...
@Sensitive
public class Inh3CSensitiveFromPDoLogGpPlainSubject extends Inh3PDoLogFromGpPlainSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CSensitiveFromPDoLogGpPlainSubject inst = new Inh3CSensitiveFromPDoLogGpPlainSubject();
