...
public class Inh3CPlainFromPSensitiveGpSensitiveSubject extends Inh3PSensitiveFromGpSensitiveSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CPlainFromPSensitiveGpSensitiveSubject inst = new Inh3CPlainFromPSensitiveGpSensitiveSubject();
