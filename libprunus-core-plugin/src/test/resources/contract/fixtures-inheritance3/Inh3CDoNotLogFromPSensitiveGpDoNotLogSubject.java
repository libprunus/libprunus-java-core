...
@DoNotLog
public class Inh3CDoNotLogFromPSensitiveGpDoNotLogSubject extends Inh3PSensitiveFromGpDoNotLogSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CDoNotLogFromPSensitiveGpDoNotLogSubject inst = new Inh3CDoNotLogFromPSensitiveGpDoNotLogSubject();
