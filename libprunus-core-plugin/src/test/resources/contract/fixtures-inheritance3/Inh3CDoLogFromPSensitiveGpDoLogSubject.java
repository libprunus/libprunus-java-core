...
@DoLog
public class Inh3CDoLogFromPSensitiveGpDoLogSubject extends Inh3PSensitiveFromGpDoLogSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CDoLogFromPSensitiveGpDoLogSubject inst = new Inh3CDoLogFromPSensitiveGpDoLogSubject();
