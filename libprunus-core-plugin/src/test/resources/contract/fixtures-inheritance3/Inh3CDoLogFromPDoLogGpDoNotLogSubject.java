...
@DoLog
public class Inh3CDoLogFromPDoLogGpDoNotLogSubject extends Inh3PDoLogFromGpDoNotLogSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CDoLogFromPDoLogGpDoNotLogSubject inst = new Inh3CDoLogFromPDoLogGpDoNotLogSubject();
