...
@Sensitive
public class Inh3CSensitiveFromPDoNotLogGpSensitiveSubject extends Inh3PDoNotLogFromGpSensitiveSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CSensitiveFromPDoNotLogGpSensitiveSubject inst = new Inh3CSensitiveFromPDoNotLogGpSensitiveSubject();
