...
@DoLog
public class Inh3CDoLogFromPPlainGpPlainSubject extends Inh3PPlainFromGpPlainSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CDoLogFromPPlainGpPlainSubject inst = new Inh3CDoLogFromPPlainGpPlainSubject();
