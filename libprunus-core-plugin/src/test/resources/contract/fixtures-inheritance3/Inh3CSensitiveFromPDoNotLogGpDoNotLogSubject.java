...
@Sensitive
public class Inh3CSensitiveFromPDoNotLogGpDoNotLogSubject extends Inh3PDoNotLogFromGpDoNotLogSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CSensitiveFromPDoNotLogGpDoNotLogSubject inst = new Inh3CSensitiveFromPDoNotLogGpDoNotLogSubject();
