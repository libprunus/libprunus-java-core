...
@DoLog
public class Inh3CDoLogFromPPlainGpSensitiveSubject extends Inh3PPlainFromGpSensitiveSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CDoLogFromPPlainGpSensitiveSubject inst = new Inh3CDoLogFromPPlainGpSensitiveSubject();
