...
@DoLog
public class Inh3CDoLogFromPDoNotLogGpDoNotLogSubject extends Inh3PDoNotLogFromGpDoNotLogSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CDoLogFromPDoNotLogGpDoNotLogSubject inst = new Inh3CDoLogFromPDoNotLogGpDoNotLogSubject();
