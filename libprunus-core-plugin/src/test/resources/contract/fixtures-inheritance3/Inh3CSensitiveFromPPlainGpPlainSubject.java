...
@Sensitive
public class Inh3CSensitiveFromPPlainGpPlainSubject extends Inh3PPlainFromGpPlainSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CSensitiveFromPPlainGpPlainSubject inst = new Inh3CSensitiveFromPPlainGpPlainSubject();
