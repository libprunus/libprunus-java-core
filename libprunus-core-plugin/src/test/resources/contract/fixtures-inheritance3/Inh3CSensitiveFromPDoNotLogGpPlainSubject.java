...
@Sensitive
public class Inh3CSensitiveFromPDoNotLogGpPlainSubject extends Inh3PDoNotLogFromGpPlainSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CSensitiveFromPDoNotLogGpPlainSubject inst = new Inh3CSensitiveFromPDoNotLogGpPlainSubject();
