...
@DoLog
public class Inh3CDoLogFromPSensitiveGpDoNotLogSubject extends Inh3PSensitiveFromGpDoNotLogSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CDoLogFromPSensitiveGpDoNotLogSubject inst = new Inh3CDoLogFromPSensitiveGpDoNotLogSubject();
