...
@DoLog
public class Inh3CDoLogFromPDoNotLogGpPlainSubject extends Inh3PDoNotLogFromGpPlainSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CDoLogFromPDoNotLogGpPlainSubject inst = new Inh3CDoLogFromPDoNotLogGpPlainSubject();
