...
public class Inh3CPlainFromPDoLogGpPlainSubject extends Inh3PDoLogFromGpPlainSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CPlainFromPDoLogGpPlainSubject inst = new Inh3CPlainFromPDoLogGpPlainSubject();
