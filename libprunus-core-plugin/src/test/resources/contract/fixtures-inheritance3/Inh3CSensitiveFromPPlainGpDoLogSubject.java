...
@Sensitive
public class Inh3CSensitiveFromPPlainGpDoLogSubject extends Inh3PPlainFromGpDoLogSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CSensitiveFromPPlainGpDoLogSubject inst = new Inh3CSensitiveFromPPlainGpDoLogSubject();
