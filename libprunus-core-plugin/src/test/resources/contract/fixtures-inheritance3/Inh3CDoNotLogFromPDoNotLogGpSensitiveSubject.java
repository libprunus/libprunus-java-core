...
@DoNotLog
public class Inh3CDoNotLogFromPDoNotLogGpSensitiveSubject extends Inh3PDoNotLogFromGpSensitiveSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CDoNotLogFromPDoNotLogGpSensitiveSubject inst = new Inh3CDoNotLogFromPDoNotLogGpSensitiveSubject();
