...
@DoNotLog
public class Inh3CDoNotLogFromPPlainGpSensitiveSubject extends Inh3PPlainFromGpSensitiveSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CDoNotLogFromPPlainGpSensitiveSubject inst = new Inh3CDoNotLogFromPPlainGpSensitiveSubject();
