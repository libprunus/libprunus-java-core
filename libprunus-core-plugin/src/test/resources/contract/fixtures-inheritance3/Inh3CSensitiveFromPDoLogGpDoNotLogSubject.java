...
@Sensitive
public class Inh3CSensitiveFromPDoLogGpDoNotLogSubject extends Inh3PDoLogFromGpDoNotLogSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CSensitiveFromPDoLogGpDoNotLogSubject inst = new Inh3CSensitiveFromPDoLogGpDoNotLogSubject();
