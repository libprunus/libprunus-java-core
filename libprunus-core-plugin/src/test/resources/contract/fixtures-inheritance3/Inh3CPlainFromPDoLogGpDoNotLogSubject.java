...
public class Inh3CPlainFromPDoLogGpDoNotLogSubject extends Inh3PDoLogFromGpDoNotLogSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CPlainFromPDoLogGpDoNotLogSubject inst = new Inh3CPlainFromPDoLogGpDoNotLogSubject();
