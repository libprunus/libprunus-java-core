...
@Sensitive
public class Inh3CSensitiveFromPDoLogGpDoLogSubject extends Inh3PDoLogFromGpDoLogSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CSensitiveFromPDoLogGpDoLogSubject inst = new Inh3CSensitiveFromPDoLogGpDoLogSubject();
