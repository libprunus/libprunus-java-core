...
@DoNotLog
public class Inh3CDoNotLogFromPDoNotLogGpDoLogSubject extends Inh3PDoNotLogFromGpDoLogSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CDoNotLogFromPDoNotLogGpDoLogSubject inst = new Inh3CDoNotLogFromPDoNotLogGpDoLogSubject();
