...
@DoNotLog
public class Inh3CDoNotLogFromPPlainGpDoNotLogSubject extends Inh3PPlainFromGpDoNotLogSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CDoNotLogFromPPlainGpDoNotLogSubject inst = new Inh3CDoNotLogFromPPlainGpDoNotLogSubject();
