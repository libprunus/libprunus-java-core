...
@DoNotLog
public class Inh3CDoNotLogFromPDoLogGpPlainSubject extends Inh3PDoLogFromGpPlainSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CDoNotLogFromPDoLogGpPlainSubject inst = new Inh3CDoNotLogFromPDoLogGpPlainSubject();
