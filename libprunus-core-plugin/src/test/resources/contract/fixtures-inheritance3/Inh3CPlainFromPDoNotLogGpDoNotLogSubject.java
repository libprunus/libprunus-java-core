...
public class Inh3CPlainFromPDoNotLogGpDoNotLogSubject extends Inh3PDoNotLogFromGpDoNotLogSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CPlainFromPDoNotLogGpDoNotLogSubject inst = new Inh3CPlainFromPDoNotLogGpDoNotLogSubject();
