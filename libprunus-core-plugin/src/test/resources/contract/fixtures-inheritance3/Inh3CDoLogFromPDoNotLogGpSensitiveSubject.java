...
@DoLog
public class Inh3CDoLogFromPDoNotLogGpSensitiveSubject extends Inh3PDoNotLogFromGpSensitiveSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CDoLogFromPDoNotLogGpSensitiveSubject inst = new Inh3CDoLogFromPDoNotLogGpSensitiveSubject();
