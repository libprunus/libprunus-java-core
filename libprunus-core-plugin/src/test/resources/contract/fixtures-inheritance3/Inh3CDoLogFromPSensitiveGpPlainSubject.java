...
@DoLog
public class Inh3CDoLogFromPSensitiveGpPlainSubject extends Inh3PSensitiveFromGpPlainSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CDoLogFromPSensitiveGpPlainSubject inst = new Inh3CDoLogFromPSensitiveGpPlainSubject();
