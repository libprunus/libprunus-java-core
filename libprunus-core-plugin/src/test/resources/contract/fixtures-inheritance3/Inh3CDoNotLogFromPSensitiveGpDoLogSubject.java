...
@DoNotLog
public class Inh3CDoNotLogFromPSensitiveGpDoLogSubject extends Inh3PSensitiveFromGpDoLogSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CDoNotLogFromPSensitiveGpDoLogSubject inst = new Inh3CDoNotLogFromPSensitiveGpDoLogSubject();
