...
public class Inh3CPlainFromPSensitiveGpDoLogSubject extends Inh3PSensitiveFromGpDoLogSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CPlainFromPSensitiveGpDoLogSubject inst = new Inh3CPlainFromPSensitiveGpDoLogSubject();
