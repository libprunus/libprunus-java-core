...
@DoLog
public class Inh3CDoLogFromPDoLogGpDoLogSubject extends Inh3PDoLogFromGpDoLogSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CDoLogFromPDoLogGpDoLogSubject inst = new Inh3CDoLogFromPDoLogGpDoLogSubject();
