...
@Sensitive
public class Inh3CSensitiveFromPSensitiveGpSensitiveSubject extends Inh3PSensitiveFromGpSensitiveSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CSensitiveFromPSensitiveGpSensitiveSubject inst = new Inh3CSensitiveFromPSensitiveGpSensitiveSubject();
