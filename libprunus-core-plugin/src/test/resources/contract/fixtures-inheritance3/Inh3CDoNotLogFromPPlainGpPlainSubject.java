...
@DoNotLog
public class Inh3CDoNotLogFromPPlainGpPlainSubject extends Inh3PPlainFromGpPlainSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CDoNotLogFromPPlainGpPlainSubject inst = new Inh3CDoNotLogFromPPlainGpPlainSubject();
