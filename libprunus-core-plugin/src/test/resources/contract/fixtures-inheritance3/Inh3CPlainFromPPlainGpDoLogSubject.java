...
public class Inh3CPlainFromPPlainGpDoLogSubject extends Inh3PPlainFromGpDoLogSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CPlainFromPPlainGpDoLogSubject inst = new Inh3CPlainFromPPlainGpDoLogSubject();
