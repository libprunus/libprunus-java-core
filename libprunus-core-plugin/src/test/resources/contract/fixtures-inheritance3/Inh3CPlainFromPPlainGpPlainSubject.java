...
public class Inh3CPlainFromPPlainGpPlainSubject extends Inh3PPlainFromGpPlainSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CPlainFromPPlainGpPlainSubject inst = new Inh3CPlainFromPPlainGpPlainSubject();
