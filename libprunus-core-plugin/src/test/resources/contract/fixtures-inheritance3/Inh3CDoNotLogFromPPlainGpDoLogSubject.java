...
@DoNotLog
public class Inh3CDoNotLogFromPPlainGpDoLogSubject extends Inh3PPlainFromGpDoLogSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CDoNotLogFromPPlainGpDoLogSubject inst = new Inh3CDoNotLogFromPPlainGpDoLogSubject();
