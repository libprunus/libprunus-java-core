...
@Sensitive
public class Inh3CSensitiveFromPSensitiveGpPlainSubject extends Inh3PSensitiveFromGpPlainSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CSensitiveFromPSensitiveGpPlainSubject inst = new Inh3CSensitiveFromPSensitiveGpPlainSubject();
