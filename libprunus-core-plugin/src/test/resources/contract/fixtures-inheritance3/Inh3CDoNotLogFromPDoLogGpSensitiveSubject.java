...
@DoNotLog
public class Inh3CDoNotLogFromPDoLogGpSensitiveSubject extends Inh3PDoLogFromGpSensitiveSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CDoNotLogFromPDoLogGpSensitiveSubject inst = new Inh3CDoNotLogFromPDoLogGpSensitiveSubject();
