...
public class Inh3CPlainFromPDoNotLogGpDoLogSubject extends Inh3PDoNotLogFromGpDoLogSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CPlainFromPDoNotLogGpDoLogSubject inst = new Inh3CPlainFromPDoNotLogGpDoLogSubject();
