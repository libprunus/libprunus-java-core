...
@Sensitive
public class Inh3CSensitiveFromPSensitiveGpDoLogSubject extends Inh3PSensitiveFromGpDoLogSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CSensitiveFromPSensitiveGpDoLogSubject inst = new Inh3CSensitiveFromPSensitiveGpDoLogSubject();
