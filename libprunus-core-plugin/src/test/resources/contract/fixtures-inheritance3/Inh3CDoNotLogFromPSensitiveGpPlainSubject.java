...
@DoNotLog
public class Inh3CDoNotLogFromPSensitiveGpPlainSubject extends Inh3PSensitiveFromGpPlainSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CDoNotLogFromPSensitiveGpPlainSubject inst = new Inh3CDoNotLogFromPSensitiveGpPlainSubject();
