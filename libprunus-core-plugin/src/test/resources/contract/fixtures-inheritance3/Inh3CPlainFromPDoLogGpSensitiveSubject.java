...
public class Inh3CPlainFromPDoLogGpSensitiveSubject extends Inh3PDoLogFromGpSensitiveSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CPlainFromPDoLogGpSensitiveSubject inst = new Inh3CPlainFromPDoLogGpSensitiveSubject();
