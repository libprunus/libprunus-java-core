...
public class Inh3CPlainFromPDoLogGpDoLogSubject extends Inh3PDoLogFromGpDoLogSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CPlainFromPDoLogGpDoLogSubject inst = new Inh3CPlainFromPDoLogGpDoLogSubject();
