...
@DoLog
public class Inh3CDoLogFromPDoNotLogGpDoLogSubject extends Inh3PDoNotLogFromGpDoLogSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CDoLogFromPDoNotLogGpDoLogSubject inst = new Inh3CDoLogFromPDoNotLogGpDoLogSubject();
