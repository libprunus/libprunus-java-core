...
@DoLog
public class Inh3CDoLogFromPPlainGpDoNotLogSubject extends Inh3PPlainFromGpDoNotLogSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CDoLogFromPPlainGpDoNotLogSubject inst = new Inh3CDoLogFromPPlainGpDoNotLogSubject();
