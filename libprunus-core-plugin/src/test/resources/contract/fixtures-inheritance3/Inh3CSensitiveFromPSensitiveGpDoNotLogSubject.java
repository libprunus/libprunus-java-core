...
@Sensitive
public class Inh3CSensitiveFromPSensitiveGpDoNotLogSubject extends Inh3PSensitiveFromGpDoNotLogSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CSensitiveFromPSensitiveGpDoNotLogSubject inst = new Inh3CSensitiveFromPSensitiveGpDoNotLogSubject();
