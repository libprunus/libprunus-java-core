...
@Sensitive
public class Inh3CSensitiveFromPDoNotLogGpDoLogSubject extends Inh3PDoNotLogFromGpDoLogSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CSensitiveFromPDoNotLogGpDoLogSubject inst = new Inh3CSensitiveFromPDoNotLogGpDoLogSubject();
