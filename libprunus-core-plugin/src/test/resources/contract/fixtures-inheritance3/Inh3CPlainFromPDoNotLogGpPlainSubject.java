...
public class Inh3CPlainFromPDoNotLogGpPlainSubject extends Inh3PDoNotLogFromGpPlainSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CPlainFromPDoNotLogGpPlainSubject inst = new Inh3CPlainFromPDoNotLogGpPlainSubject();
