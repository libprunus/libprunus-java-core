...
@DoLog
public class Inh3CDoLogFromPSensitiveGpSensitiveSubject extends Inh3PSensitiveFromGpSensitiveSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CDoLogFromPSensitiveGpSensitiveSubject inst = new Inh3CDoLogFromPSensitiveGpSensitiveSubject();
