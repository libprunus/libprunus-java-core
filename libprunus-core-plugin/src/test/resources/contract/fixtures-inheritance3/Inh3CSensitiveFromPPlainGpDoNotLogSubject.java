...
@Sensitive
public class Inh3CSensitiveFromPPlainGpDoNotLogSubject extends Inh3PPlainFromGpDoNotLogSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CSensitiveFromPPlainGpDoNotLogSubject inst = new Inh3CSensitiveFromPPlainGpDoNotLogSubject();
