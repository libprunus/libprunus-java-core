...
public class Inh3CPlainFromPPlainGpDoNotLogSubject extends Inh3PPlainFromGpDoNotLogSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CPlainFromPPlainGpDoNotLogSubject inst = new Inh3CPlainFromPPlainGpDoNotLogSubject();
