...
@Sensitive
public class Inh3CSensitiveFromPDoLogGpSensitiveSubject extends Inh3PDoLogFromGpSensitiveSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CSensitiveFromPDoLogGpSensitiveSubject inst = new Inh3CSensitiveFromPDoLogGpSensitiveSubject();
