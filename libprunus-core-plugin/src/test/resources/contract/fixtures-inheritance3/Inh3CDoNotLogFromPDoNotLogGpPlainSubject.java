...
@DoNotLog
public class Inh3CDoNotLogFromPDoNotLogGpPlainSubject extends Inh3PDoNotLogFromGpPlainSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CDoNotLogFromPDoNotLogGpPlainSubject inst = new Inh3CDoNotLogFromPDoNotLogGpPlainSubject();
