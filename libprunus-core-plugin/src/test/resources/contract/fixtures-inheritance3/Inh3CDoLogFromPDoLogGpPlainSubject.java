...
@DoLog
public class Inh3CDoLogFromPDoLogGpPlainSubject extends Inh3PDoLogFromGpPlainSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CDoLogFromPDoLogGpPlainSubject inst = new Inh3CDoLogFromPDoLogGpPlainSubject();
