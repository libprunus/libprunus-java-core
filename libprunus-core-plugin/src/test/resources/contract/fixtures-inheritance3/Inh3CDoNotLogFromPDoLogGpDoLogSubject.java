...
@DoNotLog
public class Inh3CDoNotLogFromPDoLogGpDoLogSubject extends Inh3PDoLogFromGpDoLogSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CDoNotLogFromPDoLogGpDoLogSubject inst = new Inh3CDoNotLogFromPDoLogGpDoLogSubject();
