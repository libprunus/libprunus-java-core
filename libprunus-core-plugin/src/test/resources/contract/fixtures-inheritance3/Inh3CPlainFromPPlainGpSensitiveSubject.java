...
public class Inh3CPlainFromPPlainGpSensitiveSubject extends Inh3PPlainFromGpSensitiveSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CPlainFromPPlainGpSensitiveSubject inst = new Inh3CPlainFromPPlainGpSensitiveSubject();
