...
@DoLog
public class Inh3CDoLogFromPDoLogGpSensitiveSubject extends Inh3PDoLogFromGpSensitiveSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CDoLogFromPDoLogGpSensitiveSubject inst = new Inh3CDoLogFromPDoLogGpSensitiveSubject();
