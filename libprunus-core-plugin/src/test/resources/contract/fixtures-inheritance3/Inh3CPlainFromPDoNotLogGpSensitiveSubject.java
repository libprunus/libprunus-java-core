...
public class Inh3CPlainFromPDoNotLogGpSensitiveSubject extends Inh3PDoNotLogFromGpSensitiveSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CPlainFromPDoNotLogGpSensitiveSubject inst = new Inh3CPlainFromPDoNotLogGpSensitiveSubject();
