...
@Sensitive
public class Inh3CSensitiveFromPPlainGpSensitiveSubject extends Inh3PPlainFromGpSensitiveSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CSensitiveFromPPlainGpSensitiveSubject inst = new Inh3CSensitiveFromPPlainGpSensitiveSubject();
