...
@DoLog
public class Inh3CDoLogFromPPlainGpDoLogSubject extends Inh3PPlainFromGpDoLogSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CDoLogFromPPlainGpDoLogSubject inst = new Inh3CDoLogFromPPlainGpDoLogSubject();
