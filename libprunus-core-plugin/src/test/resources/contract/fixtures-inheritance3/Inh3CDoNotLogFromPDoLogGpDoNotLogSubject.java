...
@DoNotLog
public class Inh3CDoNotLogFromPDoLogGpDoNotLogSubject extends Inh3PDoLogFromGpDoNotLogSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CDoNotLogFromPDoLogGpDoNotLogSubject inst = new Inh3CDoNotLogFromPDoLogGpDoNotLogSubject();
