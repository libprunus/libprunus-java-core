...
public class Inh3CPlainFromPSensitiveGpPlainSubject extends Inh3PSensitiveFromGpPlainSubject {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            Inh3CPlainFromPSensitiveGpPlainSubject inst = new Inh3CPlainFromPSensitiveGpPlainSubject();
