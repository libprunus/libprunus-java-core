...
public class ExtendedClassDoLogCallsiteAccessMatrixService extends ClassDoLogCallsiteAccessMatrixService {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            ExtendedClassDoLogCallsiteAccessMatrixService instance =
                    new ExtendedClassDoLogCallsiteAccessMatrixService();
            CallsiteCapture.step(
                    boundary,
                    "publicStatic",
                    () -> ClassDoLogCallsiteAccessMatrixService.publicStatic("arg-publicStatic"));
            CallsiteCapture.step(
                    boundary,
                    "protectedStatic",
                    () -> ClassDoLogCallsiteAccessMatrixService.protectedStatic("arg-protectedStatic"));
            CallsiteCapture.step(
                    boundary,
                    "publicInstance",
