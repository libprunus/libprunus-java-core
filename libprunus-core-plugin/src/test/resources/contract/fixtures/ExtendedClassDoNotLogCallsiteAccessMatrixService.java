...
public class ExtendedClassDoNotLogCallsiteAccessMatrixService extends ClassDoNotLogCallsiteAccessMatrixService {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            ExtendedClassDoNotLogCallsiteAccessMatrixService instance =
                    new ExtendedClassDoNotLogCallsiteAccessMatrixService();
            CallsiteCapture.step(
                    boundary,
                    "publicStatic",
                    () -> ClassDoNotLogCallsiteAccessMatrixService.publicStatic("arg-publicStatic"));
            CallsiteCapture.step(
                    boundary,
                    "protectedStatic",
                    () -> ClassDoNotLogCallsiteAccessMatrixService.protectedStatic("arg-protectedStatic"));
            CallsiteCapture.step(
                    boundary,
                    "publicInstance",
