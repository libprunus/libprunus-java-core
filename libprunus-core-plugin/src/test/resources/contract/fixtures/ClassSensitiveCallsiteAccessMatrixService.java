...
@Sensitive
public class ClassSensitiveCallsiteAccessMatrixService {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            ClassSensitiveCallsiteAccessMatrixService instance = new ClassSensitiveCallsiteAccessMatrixService();
