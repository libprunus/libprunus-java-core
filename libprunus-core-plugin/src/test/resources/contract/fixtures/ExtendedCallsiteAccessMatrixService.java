...
public class ExtendedCallsiteAccessMatrixService extends CallsiteAccessMatrixService {
    ...
    public static String invokeAll() {
        return CallsiteCapture.capture(() -> {
            ...
            ExtendedCallsiteAccessMatrixService instance = new ExtendedCallsiteAccessMatrixService();
            CallsiteCapture.step(
                    boundary, "publicStatic", () -> CallsiteAccessMatrixService.publicStatic("arg-publicStatic"));
            CallsiteCapture.step(
                    boundary,
                    "protectedStatic",
                    () -> CallsiteAccessMatrixService.protectedStatic("arg-protectedStatic"));
            CallsiteCapture.step(
                    boundary,
                    "publicInstance",
